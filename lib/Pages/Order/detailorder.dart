            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(document["informationPersonal"]["name"],
                  ...
                  Text(document["informationPersonal"]["paymentMethod"],
                      style: TextStyle(fontSize: 18.0)),
                  SizedBox(
                    height: 10,
                  ),
                  Text("Your products",
                      style: TextStyle(
                          fontWeight: FontWeight.bold, fontSize: 20.0)),
                  Column(
                    children: ProductR.fromSnapshot(document)
                        .products
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Container(
                    ...
                    width: 70,
                    child: ListView(
                      children: <Widget>[_totalCost(document)],
                    ),
                  ),
                ],
              ),
